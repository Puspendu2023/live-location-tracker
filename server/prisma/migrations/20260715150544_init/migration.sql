...
-- CreateEnum
CREATE TYPE "GeofenceType" AS ENUM ('CIRCULAR', 'POLYGON');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('USER_ONLINE', 'USER_OFFLINE', 'GPS_DISABLED', 'LOW_ACCURACY', 'GEOFENCE_ENTRY', 'GEOFENCE_EXIT', 'SOS_ALERT');
...
CREATE TABLE "geofences" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "type" "GeofenceType" NOT NULL DEFAULT 'CIRCULAR',
...
-- CreateIndex
CREATE INDEX "locations_userId_timestamp_idx" ON "locations"("userId", "timestamp" DESC);
